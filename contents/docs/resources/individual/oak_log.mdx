...
| ---------------------------------------------------------- | --------- | ------ | --- | -----------: |
| **[Make Oak Plank](/docs/resources/individual/oak_plank)** | Carpentry | Lv. 30 | 80  | 1x Oak Plank |
| **[Make Charcoal](/docs/resources/individual/charcoal)**   | Smithing  | Lv. 30 | 80  | 4x Charcoals |
